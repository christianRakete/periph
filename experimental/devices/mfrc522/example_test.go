...
import (
	...
	"github.com/christianRakete/periph/experimental/devices/mfrc522"
	"github.com/christianRakete/periph/experimental/devices/mfrc522/commands"
	"github.com/christianRakete/periph/host"
	"github.com/christianRakete/periph/host/rpi"
)
...
func Example() {
	...
	// Using SPI as an example. See package "github.com/christianRakete/periph/conn/spi/spireg" for more details.
	p, err := spireg.Open("")
	if err != nil {
		log.Fatal(err)
	}
